...
function setup_lockouts()
	Anguish_Lockouts = {
		...
		[317003] = {TURE_EVENT,        seconds('4d12h'), Spawn_ture},
		[317002] = {HANVAR_EVENT,      seconds('4d12h'), Spawn_hanvar},
		[317107] = {AMV_EVENT,         seconds('4d12h'), PH_amv},
		[317109] = {OMM_EVENT,         seconds('4d12h'), Spawn_omm},
		[1]      = {LOWER_GLOBE_EVENT, seconds('4d12h'), PH_lorb},
